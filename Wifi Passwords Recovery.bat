...
Set "Copyright=by R00B!Ni 2022"
Title  %~n0 %Copyright%
Mode con cols=75 lines=8
cls & color 0D & echo.
	echo            ************************************************
	echo                 %~n0 %Copyright%
	echo                     www.github.com/roobini-gamer
	echo            ************************************************
	echo
	echo
	echo
...
%Mod%
	...
	echo            ************************************************
	echo(
Call :Color 0B "                 [N][SSID] ================ Password" 1
echo(
(
	echo            ************************************************
	echo                 %~n0 %Copyright%
...
echo(
echo	Done There's a text file next to the script all the results are there
echo	Good bye O_o
